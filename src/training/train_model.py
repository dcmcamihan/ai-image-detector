...
"""Core training executed in this module; helpers live in trainer_utils.py."""


def train(config_path: str = "config/training.yaml") -> None:
    ...
    save_dir = Path(cfg.get("save_dir", "models/saved"))
    ...
    if "standardized" not in str(data_root):
        raise ValueError(
            ...
            f"This is NOT the standardized dataset. Please update config/training.yaml "
