...
def train(config_path: str = "config/training_balanced.yaml") -> None:
    ...
    save_dir = Path(cfg.get("save_dir", "models/balanced_training"))
    ...
    if "standardized" not in str(data_root):
        raise ValueError(
            ...
            f"This is NOT the standardized dataset. Please update config/training_balanced.yaml "
    ...
    # Load data (uses WeightedRandomSampler internally now)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="config/training_balanced.yaml")
